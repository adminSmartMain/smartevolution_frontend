...
import DetailApproval from "./components";
import {
  GetBuyOrderPDF,
  GetSellOrder,
  getOperationById,
...
const Detail = () => {
  ...
  const {
    fetch: GetSellOrderFetch,
    loading: loadingGetSellOrderFetch,
    error: errorGetSellOrderFetch,
    data: dataGetSellOrderFetch,
  } = useFetch({ service: GetSellOrder, init: false });
