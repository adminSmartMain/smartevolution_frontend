...
export const uploadExcel = async (formData) => {
  const res = await Axios.post(`${API_URL}/preOperation/uploadExcel`, formData, {
    headers: {
      authorization: "Bearer " + localStorage.getItem("access-token"),
...
export const registerOperationFromUpload = async (payload) => {
  const res = await Axios.post(`${API_URL}/preOperation/registerOperationFromUpload`, payload, {
    headers: {
      authorization: "Bearer " + localStorage.getItem("access-token"),
    },
  });
...
export const GetPayersFromOperationRelated = async (params) => {
  console.log(params)
  const res = await Axios.get(
    `${API_URL}/preOperation/emitter-related-payers/?emitterId=${params}`,
    {
      headers: {
        authorization: "Bearer " + localStorage.getItem("access-token"),
      },
...
export const GetOperationsByEmitterPayer = async (params) => {
  console.log(params)
  const res = await Axios.get(
    `${API_URL}/preOperation/massive-receipt/`,
    {
      headers: {
        authorization: "Bearer " + localStorage.getItem("access-token"),
      },
...
export const MassiveReceiptPreview = async (payload) => {
  const res = await Axios.post(
    `${API_URL}/receipt/preOperation/massive-receipt/preview/`,
    payload,
    {
      headers: {
        authorization: "Bearer " + localStorage.getItem("access-token"),
...
export const MassiveReceiptUploadExcel = async (formData) => {
  const res = await Axios.post(
    `${API_URL}/receipt/preOperation/massive-receipt/upload-excel/`,
    formData,
    {
      headers: {
        authorization: "Bearer " + localStorage.getItem("access-token"),
...
export const MassiveReceiptRegister = async (payload) => {
  const res = await Axios.post(
    `${API_URL}/receipt/preOperation/massive-receipt/register/`,
    payload,
    {
      headers: {
        authorization: "Bearer " + localStorage.getItem("access-token"),
