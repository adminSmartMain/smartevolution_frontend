...
import { GetDepositByID, ModifyDepositQuery, RegisterDepositQuery } from "./queries";
...
export default function RegisterDeposit() {
  ...
  const validationSchema = object({
    ...
    description: string("Ingresa una observación").nullable(true),
  });
  ...
  return (
    <>
      <Head>
        <title>
          {option === "register" ? "Registrar giro-inversionista" : null}
          {option === "modify" ? "Modificar giro-inversionista" : null}
          {option === "preview" ? "Visualizar giro-inversionista" : null}
        </title>
