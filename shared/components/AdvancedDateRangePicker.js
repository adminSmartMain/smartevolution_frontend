...
function AdvancedDateRangePicker({ onApply,onClean }) {
          ...
          <Grid container spacing={2}>
            <Grid item xs={6}>
              <TextField
                ...
                InputLabelProps={{ shrink: !!startDate}}  // Igual para la fecha final
            ...
            <Grid item xs={6}>
              <TextField
                ...
                InputLabelProps={{ shrink: !!endDate }}  // Igual para la fecha final
  ...
  <StyledApplyButton onClick={() => onApply({ 
    startDate: startDate, 
    endDate: endDate 
  })}>
    Aplicar
