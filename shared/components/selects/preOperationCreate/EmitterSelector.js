...
export default function EmitterSelector({setPendingClear,setIsModalEmitterAd,errors,emitterSaved, payers,setFieldTouched,setFieldValue,setEmitterSaved,touched,values,emisores,brokeDelete,isCreatingBill,fetchBrokerByClient,cargarTasaDescuento,setOpenEmitterBrokerModal,setClientEmitter,setClientBrokerEmitter,cargarFacturas}) {
